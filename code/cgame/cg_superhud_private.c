...
static superHUDConfigElement_t superHUDConfigItemElements[] =
{
	...
	{ "necrolog1", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog1Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog2", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog2Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog3", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog3Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog4", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog4Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog5", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog5Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog6", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog6Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog7", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog7Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
	{ "necrolog8", SE_SPECT | SE_DEAD | SE_SCORES, CG_SHUDElementNecrolog8Create, CG_SHUDElementNecrologRoutine, CG_SHUDElementNecrologDestroy },
