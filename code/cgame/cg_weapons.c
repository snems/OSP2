...
void CG_MissileHitWall(int weapon, int clientNum, vec3_t origin, vec3_t dir, impactSound_t soundType)
{
	...
	switch (weapon)
	{
		...
		case WP_GRENADE_LAUNCHER:
			...
			radius = 64;
			light = 300;
			lightColor[0] = cg_dlight_gl_explosionR.value;
			lightColor[1] = cg_dlight_gl_explosionG.value;
			lightColor[2] = cg_dlight_gl_explosionB.value;
			break;
		case WP_ROCKET_LAUNCHER:
			mod = cgs.media.dishFlashModel;
			sfx = cgs.media.sfx_rockexp;
			...
			isSprite = qtrue;
			duration = 1000;
			lightColor[0] = cg_dlight_rl_explosionR.value;
			lightColor[1] = cg_dlight_rl_explosionG.value;
			lightColor[2] = cg_dlight_rl_explosionB.value;
		...
		case WP_BFG:
			...
			isSprite = qtrue;
			duration = 800;
			lightColor[0] = cg_dlight_bfg_explosionR.value ;
			lightColor[1] = cg_dlight_bfg_explosionG.value ;
			lightColor[2] = cg_dlight_bfg_explosionB.value ;
			radius = 64;
			isSprite = qtrue;
			break;
		case WP_SHOTGUN:
