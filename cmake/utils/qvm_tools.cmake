...
function(add_qvm MODULE_NAME)
    ...
    # Retreive all headers, we'll track them later to recompile qvm every time they change.
    foreach(SOURCE ${ARG_SOURCES})
        if(${SOURCE} MATCHES "\\.h(pp|xx)?$")
    ...
    foreach(SOURCE ${ARG_SOURCES})
        ...
        add_custom_command(
            ...
            DEPENDS ${SOURCE} ${HEADER_FILES} qvm_tools ${Q3RCC} ${Q3CPP} ${Q3LCC}
